#!/bin/bash
# =============================================================
# Chinese Study — Start Script (Khởi động nhanh bằng PM2)
...
echo ""
echo -e "${BOLD}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${BOLD}║       Chinese Study — Start App                          ║${NC}"
echo -e "${BOLD}╚══════════════════════════════════════════════════════════╝${NC}"
...
[ -d ".next" ] || err "Chưa có thư mục .next — hãy chạy 'npm run build' hoặc 'bash scripts/deploy.sh' trước."
[ -f ".env"  ] || warn "Không tìm thấy .env! Hãy kiểm tra lại nếu app cần API Keys."
